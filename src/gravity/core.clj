...
(defn g-force-polar
  ...
  [o1 o2]
  [(* G (/ (* ^double (scaled-mass o1) ^double (scaled-mass o2))
           (max ^double (square-distance o1 o2) 0.00000001)))   ; Ensure we don't divide by zero
   (atan2 (- ^double (:y o2) ^double (:y o1)) (- ^double (:x o2) ^double (:x o1)))])
